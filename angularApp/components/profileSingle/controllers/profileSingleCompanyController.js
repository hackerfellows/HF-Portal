/**
* ProfileSingleCompanyController
...
(function () {
    ...
    .controller('ProfileSingleCompanyController', ProfileSingleCompanyController);

    ProfileSingleCompanyController.$inject = ['$scope', '$location', 'Companies', 'User', 'Tags', 'Alert'];

    /**
    * @namespace CompanyProfileController
    */
    function ProfileSingleCompanyController($scope, $location, Companies, User, Tags, Alert) {
       /* var vm = this;
